...
**Summary:** The Debug Log Enhancements feature is underway. Phase 1, Task 1 (Log Buffer) and Task 2 (Initial Log Verbosity Reduction) are complete. Phase 2 (Startup Logging & Toggle) is pending.
...
*   **v1.2 (2025-06-20):** Updated status of Task v3.1.1.2 to `COMPLETED`. Added commit hash `378c654f` and app version tag. Updated Feature Changelog table.
*   **v1.1 (2025-06-20):** Updated status of Task v3.1.1.1 to `COMPLETED`. Added commit hash `d2ede246` and app version tag. Updated Feature Changelog table. Updated Overall Feature Status to `IN PROGRESS`.
