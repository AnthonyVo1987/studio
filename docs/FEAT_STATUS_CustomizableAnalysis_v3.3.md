...
**Summary:** This feature is planned and approved. It will replace the rigid "AI Full Analysis Macro" with a user-configurable pipeline and introduce new AI-driven web search capabilities to augment the analysis with additional data points not available from the core API. The implementation will proceed according to the phased plan outlined in the feature scope document.
...
*   **Tasks:**
    *   **v3.3.1.0.0:** Remove "AI Full Analysis Macro" button. (`PLANNED`)
    *   **v3.3.1.1.0:** Add primary analysis toggles. (`PLANNED`)
    *   **v3.3.1.2.0:** Add augmented web search toggles. (`PLANNED`)
...
| :--------- | :---------------------------- | :-------------------------- | :-------------------------------------------------- | :-------- |
| 2025-06-22 | `v3.3.0.0.0` (Feature Scoped) | TBD                         | Feature scope and implementation plan approved. Documents generated. | PLANNED   |
